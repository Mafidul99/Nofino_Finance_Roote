  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="absolute -right-[240px] mt-[17px] flex h-[480px] w-[350px] flex-col rounded border border-gray-300 bg-white p-3 shadow-md sm:w-[361px] lg:right-0"
      >
        ...
        <ul className="flex flex-col h-auto overflow-y-auto custom-scrollbar">
          ...
          <li>
            <DropdownItem
              ...
              className="flex gap-3 rounded-lg border-b border-gray-300 p-3 px-4.5 py-3 hover:bg-gray-100"
            >
